...
using uo_set =
    std::unordered_set<std::shared_ptr<std::string>, StringPtrHash, StringPtrEqual>;
using uo_set_it =
    std::unordered_set<std::shared_ptr<std::string>, StringPtrHash, StringPtrEqual>::iterator;
};
